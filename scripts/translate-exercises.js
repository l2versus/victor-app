...
async function translate() {
  ...
  const names = [
    ...
    // ─── Batch 2: nomes que ficam em inglês (populares na academia BR) ───
    // Estes NÃO são traduzidos — personal já conhece pelo nome em inglês
    // Dead Bug, Dragon Flag, Box Jump, Face Pull, Battle Ropes, etc.
    // ─── Batch 2b: os poucos que TÊM tradução popular ───
