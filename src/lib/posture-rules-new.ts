...
export const NEW_EXERCISE_RULES: ExerciseRule[] = [
  ...
  // ═══ COSTAS (44) ═══
  { id: "barra-fixa-pronada", nameEn: "", name: "Barra fixa pronada", muscleGroup: "back", cameraPosition: "side", positioningTip: "De lado", analyze: (lm) => analyzePull(lm) },
  { id: "barra-fixa-supinada", nameEn: "", name: "Barra fixa supinada (chin-up costas)", muscleGroup: "back", cameraPosition: "side", positioningTip: "De lado", analyze: (lm) => analyzePull(lm) },
  { id: "barra-fixa-neutra", nameEn: "", name: "Barra fixa neutra", muscleGroup: "back", cameraPosition: "side", positioningTip: "De lado", analyze: (lm) => analyzePull(lm) },
  { id: "barra-fixa-assistida", nameEn: "", name: "Barra fixa assistida", muscleGroup: "back", cameraPosition: "side", positioningTip: "De lado", analyze: (lm) => analyzePull(lm) },
  { id: "puxada-frente-aberta", nameEn: "", name: "Puxada frente pegada aberta", muscleGroup: "back", cameraPosition: "front", positioningTip: "De frente", analyze: (lm) => analyzePull(lm) },
  { id: "puxada-frente-fechada", nameEn: "", name: "Puxada frente pegada fechada", muscleGroup: "back", cameraPosition: "front", positioningTip: "De frente", analyze: (lm) => analyzePull(lm) },
  { id: "puxada-supinada", nameEn: "", name: "Puxada supinada", muscleGroup: "back", cameraPosition: "front", positioningTip: "De frente", analyze: (lm) => analyzePull(lm) },
  { id: "puxada-neutra", nameEn: "", name: "Puxada neutra", muscleGroup: "back", cameraPosition: "front", positioningTip: "De frente", analyze: (lm) => analyzePull(lm) },
  { id: "puxada-unilateral", nameEn: "", name: "Puxada unilateral", muscleGroup: "back", cameraPosition: "front", positioningTip: "De frente", analyze: (lm) => analyzePull(lm) },
  { id: "puxada-atras", nameEn: "", name: "Puxada atrás (uso específico)", muscleGroup: "back", cameraPosition: "front", positioningTip: "De frente", analyze: (lm) => analyzePull(lm) },
  { id: "remada-curvada-barra", nameEn: "", name: "Remada curvada barra", muscleGroup: "back", cameraPosition: "side", positioningTip: "De lado, tronco inclinado", analyze: (lm) => analyzeRow(lm) },
  { id: "remada-curvada-supinada", nameEn: "", name: "Remada curvada supinada", muscleGroup: "back", cameraPosition: "side", positioningTip: "De lado", analyze: (lm) => analyzeRow(lm) },
  { id: "remada-pendlay-pt", nameEn: "", name: "Remada Pendlay", muscleGroup: "back", cameraPosition: "side", positioningTip: "De lado", analyze: (lm) => analyzeRow(lm) },
  { id: "remada-uni-halter", nameEn: "", name: "Remada unilateral halter", muscleGroup: "back", cameraPosition: "side", positioningTip: "De lado", analyze: (lm) => analyzeRow(lm) },
  { id: "remada-apoiada-banco", nameEn: "", name: "Remada apoiada no banco", muscleGroup: "back", cameraPosition: "side", positioningTip: "De lado", analyze: (lm) => analyzeRow(lm) },
  { id: "remada-baixa-cabo", nameEn: "", name: "Remada baixa no cabo", muscleGroup: "back", cameraPosition: "side", positioningTip: "De lado, sentado", analyze: (lm) => analyzeRow(lm) },
  { id: "remada-maquina-pt", nameEn: "", name: "Remada máquina", muscleGroup: "back", cameraPosition: "side", positioningTip: "De lado", analyze: (lm) => analyzeRow(lm) },
  { id: "remada-articulada-pt", nameEn: "", name: "Remada articulada", muscleGroup: "back", cameraPosition: "side", positioningTip: "De lado", analyze: (lm) => analyzeRow(lm) },
