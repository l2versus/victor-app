...
import { Camera, Lock, Crown, Zap, Shield, Eye, Activity, Scan, PersonStanding, ChevronRight, Dumbbell, Swords, ScanSearch } from "lucide-react"
...
export default async function PosturePage({ searchParams }: { searchParams: Promise<{ exercise?: string }> }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <Link
        href="/posture/fitvs"
        className="flex items-center justify-between p-3 rounded-xl bg-emerald-600/[0.06] border border-emerald-500/15 hover:bg-emerald-600/[0.10] active:scale-[0.98] transition-all"
      >
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-xs font-semibold text-white">FitVS Battle</p>
            <p className="text-[10px] text-neutral-500">Desafie um amigo em tempo real</p>
          </div>
        </div>
        <ChevronRight className="w-4 h-4 text-neutral-600" />
      </Link>
      ...
      {/* GymVision link */}
      <Link
        href="/posture/gymvision"
        className="flex items-center justify-between p-3 rounded-xl bg-cyan-600/[0.06] border border-cyan-500/15 hover:bg-cyan-600/[0.10] active:scale-[0.98] transition-all"
      >
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-xs font-semibold text-white">GymVision</p>
            <p className="text-[10px] text-neutral-500">Identifique máquinas pela câmera</p>
          </div>
        </div>
        <ChevronRight className="w-4 h-4 text-neutral-600" />
      </Link>
