...
const mainItems = [
  ...
  { href: "/nutri/meal-plans", label: "Planos", icon: ClipboardList },
...
export function NutriMobileNav() {
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-[#0a0a0a]/95 backdrop-blur-2xl p-3 shadow-2xl max-h-[65dvh] flex flex-col">
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "bg-emerald-600/10 border border-emerald-500/15 text-white"
            ...
            <div className="mt-2 pt-2 border-t border-white/[0.04] flex gap-1.5 shrink-0">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-emerald-400/70 hover:text-emerald-300 hover:bg-emerald-500/10 transition-all text-[11px] font-medium border border-emerald-500/10"
              >
